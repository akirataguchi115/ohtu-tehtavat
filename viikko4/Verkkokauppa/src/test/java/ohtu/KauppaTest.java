...
public class KauppaTest {
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikeillaParametreilla2() {
        ...
        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu
        verify(pankki).tilisiirto("pekka", 55, "12345", "33333-44455", 10);
        // toistaiseksi ei välitetty kutsussa käytetyistä parametreista
    }

    @Test
    public void samaaTuotettaOikeaSumma() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void ToistaVarastossaToistaEiOikeaSumma() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.saldo(2)).thenReturn(10);
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "peruna", 0));
